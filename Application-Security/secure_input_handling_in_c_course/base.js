(function () {
  ...
  function readCString(source, index) {
  ...
  function highlightCCode() {
    var keywords = {
      "break": true, "case": true, "continue": true, "default": true, "do": true, "else": true,
      "enum": true, "for": true, "goto": true, "if": true, "return": true, "sizeof": true,
      "static": true, "struct": true, "switch": true, "typedef": true, "while": true
    };
    var types = {
      "FILE": true, "NULL": true, "char": true, "const": true, "double": true, "float": true,
      "int": true, "long": true, "short": true, "signed": true, "size_t": true, "uint32_t": true,
      "unsigned": true, "void": true
    };
    var builtins = {
      "SIZE_MAX": true, "EOF": true, "stderr": true, "errno": true
    };
    ...
    Array.prototype.forEach.call(blocks, function (block) {
      ...
      while (index < source.length) {
        ...
        if (character === "/" && next === "*") {
          ...
          lineStart = source.slice(index, blockEnd + 2).indexOf("\n") !== -1;
          index = blockEnd + 2;
          continue;
        }

        if (character === '"' || character === "'") {
          var stringToken = readCString(source, index);
