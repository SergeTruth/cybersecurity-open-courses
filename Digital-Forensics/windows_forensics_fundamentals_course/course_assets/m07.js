window.COURSE_MODULE = {
  ...
  "narrationPoints": [
    ...
    "Live acquisition requires an explicit remote CIM target and records its operating system, boot time, hardware identity, capture authority, and analyst host.",
    "The resolved target name and hardware or VM UUID are compared with the analyst host before a live run is created.",
    "Live evidence receives a separate source_type live_host run and is refused when DFIR_RUN selects an offline-image run.",
    "Process and network captures are timestamped snapshots, and each completed window is persisted even if a later phase fails.",
    "The final success status is written only after all required capture metadata has been saved successfully."
  ]
};
