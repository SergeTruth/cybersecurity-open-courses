window.COURSE_CODE_MODULE = {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "language": "python",
      "blurb": "The adapter supplies the verified context to destination and HTTPS-proxy TLS, while the session disables environment proxy discovery so routing cannot change through inherited process configuration.",
