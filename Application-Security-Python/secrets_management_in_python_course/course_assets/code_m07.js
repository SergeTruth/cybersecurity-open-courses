  ...
  "codeExamples": [
    {
      ...
      "language": "python",
      "blurb": "The deployment step passes the credential through standard input and exposes only a fixed command and sanitized environment.",
