  ...
  "codeExamples": [
    {
      ...
      "code": "WEBHOOK_STAGES = {\"transport\", \"signature\", \"freshness\", \"schema\", \"authorization\", \"processing\"}\nWEBHOOK_OUTCOMES = {\"accepted\", \"rejected\", \"duplicate\", \"queued\", \"failed\"}\n\ndef record_webhook_decision(logger, metrics, event_id: str, stage: str, outcome: str) -> None:\n    safe_stage = stage if stage in WEBHOOK_STAGES else \"other\"\n    safe_outcome = outcome if outcome in WEBHOOK_OUTCOMES else \"other\"\n    logger.info(\n        \"webhook_decision\",\n        extra={\"event_id\": event_id, \"stage\": safe_stage, \"outcome\": safe_outcome},\n    )\n    metrics.increment(\"webhook_decisions\", tags={\"stage\": safe_stage, \"outcome\": safe_outcome})\n"
    },
    {
